package com.WebAppSecurity.utilities;
...
public class BrowserUtils {
    ...
    public static void handlingSSl(){
        Driver.get().findElement(By.cssSelector("#details-button.secondary-button")).click();

        Driver.get().findElement(By.cssSelector("#proceed-link")).click();
